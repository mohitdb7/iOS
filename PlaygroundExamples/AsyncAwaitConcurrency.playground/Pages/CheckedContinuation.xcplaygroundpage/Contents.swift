...
class DummyUserOperations {
    ...
    private func getUserDetails(completion: @escaping (Result<String, Error>)->Void) {
        do {
    ...
    private func getCompanyDetails(completion: @escaping (Result<String, Error>)->Void) {
        do {
            Thread.sleep(forTimeInterval: 3)
